...
2. **Run:** `java PixelArt`
3. **Select Color:** Click a color square at the bottom to choose your ink.
4. **Draw:** Click or drag across the grid.
5. **Save:** Click 'Save as PNG' to export your masterpiece!

##  Project Structure
- `PixelArt.java`: The core application code.
